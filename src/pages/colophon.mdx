...
updatedDate: 2025-12-29T19:25:54+00:00
---
...
Usually when I want to write something and share as a post, I open my website’s Obsidian setup and create a post using the `post_template.md` so it automatically makes a post and I can fill in the `title` and `summary` if I wanted to.
