...
updatedDate: 2025-11-10T14:46:59+00:00
---
...
> Following the guide from [IndieWeb](https://indieweb.org/colophon) for what a Colophon page includes, I’ll do my best to lay down how I’ve set up my side of the internet. Last updated <FormattedDate dateType="" dateString={frontmatter.updatedDate} />.
...
![Favicon for chisenires.design](/favicon.png)
...
For the **auto generated thumbnails**—which I [[/blog/finally-fixed-the-metadata-generation-and-the-auto-social-images|wrote about in this post]]—it’s set up using [Cloudinary](https://cloudinary.com/invites/lpov9zyyucivvxsnalc5/yks8gwi2hltjef4vokiu?t=default) (this is a referral link!).
