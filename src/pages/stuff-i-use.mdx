...
- a custom painted red Brompton named *Gold Ship*
  <figure>
    <img src={bikeGoldShip.src} alt="A red Brompton bike with its rear wheel folded under, allowing it to stand upright on its own. A red bag is mounted on the front rack with a matching red helmet resting on top. The bike is parked on the roadside in front of The Peninsula Manila, whose plaque is visible behind some greenery." loading="eager" />
    <figcaption>The first time I brought Gold Ship out for a ride after I got her</figcaption>
  </figure>
